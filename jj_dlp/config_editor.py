...
CONFIG_KEYS: tuple[_KeyDef, ...] = (
    ...
    _KeyDef("YT_DLP_PATH_WINDOWS",   "site",   "bin/yt-dlp.test",     False, 'Path to the yt-dlp executable.  "YT_DLP_PATH = bin/yt-dlp.exe" to use the bundled windows executable.  "YT_DLP_PATH = bin/yt-dlp" to use the bundled linux executable.  "YT_DLP_PATH = yt-dlp" to use PATH'),
