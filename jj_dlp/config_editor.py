...
CONFIG_KEYS: tuple[_KeyDef, ...] = (
    ...
    _KeyDef("AD_ALERT_PATTERNS",        scope="site",                      default="",                           preserve=False,               comment="Regex (case-insensitive), alternation-joined with '|', matched against yt-dlp output to detect ads. Edit this when the site changes its ad markers."),
