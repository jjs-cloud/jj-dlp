...
CONFIG_KEYS: tuple[_KeyDef, ...] = (
    ...
    _KeyDef("COLLAPSIBLE_FOLDERS",      scope="global",                    default="true",                       preserve=True, type="bool",  comment="Group File Manager files by subfolder into collapsible/expandable groups. (true/false)"),
