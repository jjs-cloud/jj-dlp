...
CONFIG_KEYS: tuple[_KeyDef, ...] = (
    ...
    _KeyDef("STALL_CHECK_INTERVAL",     scope="site",                      default="30",                         preserve=True,               comment="How often to check if the recording has stalled (in seconds).  Disable by setting this to a large number. (Default: 30)"),
    ...
    _KeyDef("LOG_PATH",                 scope="site",                      default="",                           preserve=False,              comment="Folder to save per-streamer log files. Defaults to \"logs\"."),
    ...
    _KeyDef("BROWSER",                  scope="site",                      default="firefox",                    preserve=False,              comment="The browser to use for --cookies-from-browser. One value shared by [Downloader]/[Checker]/[LQ_Downloader] wherever their own COOKIES_FROM_BROWSER = true."),
