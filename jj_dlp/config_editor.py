...
CONFIG_KEYS: tuple[_KeyDef, ...] = (
    ...
    _KeyDef("PROGRESS_BAR_WIDTH",       scope="site",                      default="58",                         preserve=True,               comment="Width of the progress bar in the site panel of the dashboard. (in characters) (only applies to the curses dashboard)"),
