...
CONFIG_KEYS: tuple[_KeyDef, ...] = (
    ...
    _KeyDef("COLLAPSIBLE_FOLDERS",      scope="global",                    default="true",                       preserve=True, type="bool",  comment="Group File Manager files by first-level subfolder (e.g. per-streamer folders created by SUBFOLDERS) into collapsible/expandable groups. (true/false)"),
