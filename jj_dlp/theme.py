...
SITE_REGISTRY = {
    ...
    'main_jjdlpdashboard_draw_site_panel_live_6': {'file': 'main.py', 'label': 'Site Panel (Normal) — Name (Live)', 'default_role': 'REC', 'default_bold': True},
    ...
    'main_jjdlpdashboard_draw_site_panel_live_9': {'file': 'main.py', 'label': 'Site Panel (Normal) — Progress Bar (Live)', 'default_role': 'CHROME', 'default_bold': False},
