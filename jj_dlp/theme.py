...
COLOR_SCHEMES = [
    ...
    (curses.COLOR_YELLOW,  curses.COLOR_WHITE,   curses.COLOR_YELLOW,
     ...
     curses.COLOR_WHITE,   curses.COLOR_BLACK,   curses.COLOR_GREEN,
     curses.COLOR_YELLOW,   curses.COLOR_WHITE,   curses.COLOR_CYAN,
     curses.COLOR_WHITE,   curses.COLOR_RED),
    # 2: Green phosphor
    (curses.COLOR_YELLOW,   curses.COLOR_WHITE,   curses.COLOR_GREEN,
    ...
    (curses.COLOR_RED,     curses.COLOR_WHITE,   curses.COLOR_RED,
     curses.COLOR_YELLOW,  curses.COLOR_GREEN,   curses.COLOR_BLACK,
     curses.COLOR_RED,     curses.COLOR_GREEN,     curses.COLOR_MAGENTA,
     curses.COLOR_WHITE,   curses.COLOR_BLACK,   curses.COLOR_GREEN,
     curses.COLOR_RED,   curses.COLOR_YELLOW,  curses.COLOR_CYAN,
    ...
    (curses.COLOR_WHITE,   curses.COLOR_BLACK,   curses.COLOR_WHITE,
     curses.COLOR_YELLOW,  curses.COLOR_GREEN,   curses.COLOR_RED,
     curses.COLOR_WHITE,   curses.COLOR_GREEN,  curses.COLOR_WHITE,
     curses.COLOR_WHITE,   curses.COLOR_BLACK,   curses.COLOR_GREEN,
...
SITE_REGISTRY = {
    ...
    'config_editor_globalconfigeditor_draw_warn': {'file': 'config_editor.py', 'label': 'Global Settings Panel — Item Key (Unselected)', 'default_role': 'NORMAL', 'default_bold': True},
    ...
    'config_editor_configeditor_draw_tab_warn_2': {'file': 'config_editor.py', 'label': 'Site Settings Panel — Section Header (Unselected)', 'default_role': 'NORMAL', 'default_bold': True},
    'config_editor_configeditor_draw_tab_warn_3': {'file': 'config_editor.py', 'label': 'Site Settings Panel — Item Key (Unselected)', 'default_role': 'NORMAL', 'default_bold': True},
    ...
    'file_manager_filemanagertab_draw_split_popup_hilight_4': {'file': 'file_manager.py', 'label': 'Split Popup — Start Job Row (Selected)', 'default_role': 'HILIGHT', 'default_bold': True},
    'file_manager_filemanagertab_draw_split_popup_normal_5': {'file': 'file_manager.py', 'label': 'Split Popup — Start Job Row (Unselected)', 'default_role': 'NORMAL', 'default_bold': False},
    'file_manager_filemanagertab_draw_split_popup_hilight_5': {'file': 'file_manager.py', 'label': 'Split Popup — Restart Recording Row (Selected)', 'default_role': 'HILIGHT', 'default_bold': True},
    'file_manager_filemanagertab_draw_split_popup_normal_6': {'file': 'file_manager.py', 'label': 'Split Popup — Restart Recording Row (Unselected)', 'default_role': 'NORMAL', 'default_bold': False},
    ...
    'file_manager_filemanagertab_draw_system_1': {'file': 'file_manager.py', 'label': 'File Manager — Subfolder Group Header', 'default_role': 'NORMAL', 'default_bold': True},
    ...
    'main_jjdlpdashboard_draw_site_panel_live_2': {'file': 'main.py', 'label': 'Site Panel (Compact) — Name (Live)', 'default_role': 'REC', 'default_bold': True},
    ...
    'main_jjdlpdashboard_draw_site_panel_dim_2': {'file': 'main.py', 'label': 'Site Panel (Compact) — Name (Offline)', 'default_role': 'NORMAL', 'default_bold': False},
    ...
    'main_jjdlpdashboard_draw_site_panel_live_5': {'file': 'main.py', 'label': 'Site Panel (Compact) — Last Live, Recently Live', 'default_role': 'NORMAL', 'default_bold': False},
    ...
    'main_jjdlpdashboard_draw_site_panel_live_6': {'file': 'main.py', 'label': 'Site Panel (Normal) — Name (Live)', 'default_role': 'LOGO', 'default_bold': True},
    ...
    'main_jjdlpdashboard_draw_site_panel_live_9': {'file': 'main.py', 'label': 'Site Panel (Normal) — Progress Bar (Live)', 'default_role': 'LOGO', 'default_bold': False},
    ...
    'main_jjdlpdashboard_draw_site_panel_live_10': {'file': 'main.py', 'label': 'Site Panel (Normal) — Last Live, Recently Live', 'default_role': 'NORMAL', 'default_bold': False},
    'main_jjdlpdashboard_draw_site_panel_dim_8': {'file': 'main.py', 'label': 'Site Panel (Normal) — Last Live, Older', 'default_role': 'DIM', 'default_bold': False},
    ...
    'main_jjdlpdashboard_draw_log_tab_dim_3': {'file': 'main.py', 'label': 'Activity Log — Line (Normal)', 'default_role': 'NORMAL', 'default_bold': False},
    'main_jjdlpdashboard_draw_log_tab_live': {'file': 'main.py', 'label': 'Activity Log — Line (Live/Recording Started)', 'default_role': 'NORMAL', 'default_bold': True},
    ...
    'main_jjdlpdashboard_draw_log_tab_warn_1': {'file': 'main.py', 'label': 'Activity Log — Line (Warning)', 'default_role': 'REC', 'default_bold': True},
    ...
    'main_jjdlpdashboard_draw_log_tab_match': {'file': 'main.py', 'label': 'Activity Log - Debug Regex Match Highlight', 'default_role': 'HILIGHT', 'default_bold': True},
    'main_jjdlpdashboard_draw_debug_filter_popup_normal': {'file': 'main.py', 'label': 'Debug Log Filters Popup - Background', 'default_role': 'NORMAL', 'default_bold': False},
    'main_jjdlpdashboard_draw_debug_filter_popup_title': {'file': 'main.py', 'label': 'Debug Log Filters Popup - Title', 'default_role': 'SYSTEM', 'default_bold': True},
    'main_jjdlpdashboard_draw_debug_filter_popup_text': {'file': 'main.py', 'label': 'Debug Log Filters Popup - Text', 'default_role': 'NORMAL', 'default_bold': False},
    'main_jjdlpdashboard_draw_debug_filter_popup_selected': {'file': 'main.py', 'label': 'Debug Log Filters Popup - Selected Row', 'default_role': 'HILIGHT', 'default_bold': True},
    'main_jjdlpdashboard_draw_debug_filter_popup_error': {'file': 'main.py', 'label': 'Debug Log Filters Popup - Regex Error', 'default_role': 'WARN', 'default_bold': True},
    'main_jjdlpdashboard_draw_debug_filter_popup_legend': {'file': 'main.py', 'label': 'Debug Log Filters Popup - Legend', 'default_role': 'INVHEAD', 'default_bold': False},
