...
def _edit_color_fields(
    stdscr, title: str, fg: str, bg: str, bold: bool, color: ColorFn
) -> Optional[Tuple[str, str, bool]]:
    """Boxed fg/bg/bold editor. Returns the edited values, or None if canceled.
