...
def open_move_popup(stdscr, file_row, color_fn: Optional[ColorFn] = None) -> Optional[str]:
    """Placeholder Move popup; Step 13.7 replaces this with the destination list/add flow."""
    _placeholder(stdscr, "Move not yet implemented.", color_fn or _default_color_fn)
    return None
