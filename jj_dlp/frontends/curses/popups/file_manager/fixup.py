"""Fixup popup: remux, optional mp4 convert, optional delete original."""
...
def open_fixup_popup(stdscr, file_row, color_fn: Optional[ColorFn] = None) -> Optional[str]:
    """Placeholder Fixup popup; Step 13.6 replaces this with the real checkboxes/run flow."""
    _placeholder(stdscr, "Fixup not yet implemented.", color_fn or _default_color_fn)
    return None
